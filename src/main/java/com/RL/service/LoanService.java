...
public class LoanService {
    ...
    public LoanResponse createLoan(CreateLoanDTO createLoanDTO) {

        User user=userRepository.findById(createLoanDTO.getUserId()).orElseThrow(()-> new ResourceNotFoundException(String.format(USER_NOT_FOUND_MESSAGE,createLoanDTO.getUserId())));
        Book book=bookRepository.findById(createLoanDTO.getBookId()).orElseThrow(()-> new ResourceNotFoundException(String.format(BOOK_NOT_FOUND_MESSAGE,createLoanDTO.getBookId())));

        LocalDateTime current=LocalDateTime.now();
        List<Loan> expiredLoans=loanRepository.findExpiredLoansBy(createLoanDTO.getUserId(),current);
