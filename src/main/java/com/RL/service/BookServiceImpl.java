...
import com.RL.controller.BookController;
...
public class BookServiceImpl implements IBookService {
    ...
    @Transactional
    @Override
    public Page<BookDTO> findAllWithPageAllBooks(Pageable pageable) {

        Page<BookDTO> books = bookRepository.findAllBookPage(pageable);
