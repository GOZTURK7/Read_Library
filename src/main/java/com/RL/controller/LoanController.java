...
public class LoanController {
    ...
    createLoan(@Valid @RequestBody CreateLoanDTO createLoanDTO
    ){

        LoanResponse loansResponse= loanService.createLoan(createLoanDTO);
    ...
    @PreAuthorize("hasRole('ADMIN') or  hasRole('EMPLOYEE')")
    @GetMapping("/loans/admin/user/{userId}")
    public ResponseEntity<List<Loan>>getLoansWithPageByUserId( @PathVariable(value="userId") Long userId,
                                                              @RequestParam ("page") int page,
                                                              @RequestParam("size") int size,
                                                              @RequestParam("sort") String prop,
                                                              @RequestParam("direction") Sort.Direction direction){
